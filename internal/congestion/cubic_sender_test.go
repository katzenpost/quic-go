...
var _ = Describe("Cubic Sender", func() {
	...
	It("tcp cubic reset epoch on quiescence", func() {
		...
		sender = newCubicSender(&clock, rttStats, false, protocol.InitialPacketSizeIPv4, maxDatagramSize, initialCongestionWindowPackets*maxDatagramSize, maxCongestionWindowBytes, nil)
	...
	It("slow starts up to the maximum congestion window", func() {
		...
		sender = newCubicSender(&clock, rttStats, true, protocol.InitialPacketSizeIPv4, maxDatagramSize, initialCongestionWindowPackets*maxDatagramSize, initialMaxCongestionWindow, nil)
	...
	It("limit cwnd increase in congestion avoidance", func() {
		// Enable Cubic.
		sender = newCubicSender(&clock, rttStats, false, protocol.InitialPacketSizeIPv4, maxDatagramSize, initialCongestionWindowPackets*maxDatagramSize, MaxCongestionWindow, nil)
		numSent := SendAvailableSendWindow()
