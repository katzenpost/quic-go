...
var newConnection = func(
	...
	s.sentPacketHandler, s.receivedPacketHandler = ackhandler.NewAckHandler(
		0,
		getMaxPacketSize(s.conn.RemoteAddr(), s.config),
		s.rttStats,
	...
	s.mtuDiscoverer = newMTUDiscoverer(s.rttStats, getMaxPacketSize(s.conn.RemoteAddr(), s.config), s.sentPacketHandler.SetMaxDatagramSize)
